...
-- Create the single, correct version of send_guests_chat_message
...
SELECT 'send_guests_chat_message function fixed successfully - all versions dropped and single version created' AS status; 