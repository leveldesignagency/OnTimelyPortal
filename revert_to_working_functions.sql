-- Revert to working functions from definitive_guest_chat_fix.sql
-- This will restore the functions that were working before

-- Restore the working send_guests_chat_message function
...
-- Restore the working get_guests_chat_messages function
