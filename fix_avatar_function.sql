-- Fix Avatar Function
-- This fixes the send_guests_chat_message function to properly handle avatar_url for admin users
...
DECLARE
  ...
  v_avatar_url TEXT;
BEGIN
  -- First check if it's an admin user (company user) - they should have avatar_url
  SELECT 
    name,
    'admin',
    company_id,
...
-- Test the setup
SELECT 'Avatar function fixed!' as status; 