-- Guest Chat Upload RPC Function
-- This function handles the entire upload process server-side for guests
...
-- Grant permissions to anon users (guests)
...
-- Test the function
SELECT 'Guest chat upload RPC function created successfully' as status; 