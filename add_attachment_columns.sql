-- Add attachment columns to guests_chat_messages table
...
BEGIN
    ...
    SELECT 
        ...
        p_attachment_url AS attachment_url,
        p_attachment_filename AS attachment_filename,
...
SELECT 'Attachment columns and functions updated successfully' AS status; 