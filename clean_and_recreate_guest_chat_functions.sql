-- Clean and recreate all guest chat functions
-- This will completely remove all versions and recreate them cleanly

-- Drop ALL versions of guest chat functions
...
-- Also drop any with specific parameter signatures
