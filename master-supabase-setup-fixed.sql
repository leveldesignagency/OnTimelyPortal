-- ============================================
-- TIMELY MASTER SUPABASE SETUP - FIXED VERSION
...
-- ============================================
-- 1. DROP ALL EXISTING POLICIES AND TRIGGERS TO AVOID CONFLICTS
-- ============================================
...
-- Drop existing triggers to avoid conflicts - use CASCADE to handle dependencies
...
DROP TRIGGER IF EXISTS update_chats_updated_at ON chats CASCADE;
...
DROP TRIGGER IF EXISTS update_team_invitations_updated_at ON team_invitations CASCADE;
...
-- ============================================
-- 4. CREATE FUNCTION AND TRIGGERS FOR UPDATED_AT
-- ============================================
...
BEGIN
    ...
    IF EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'team_invitations') THEN
...
('33333333-3333-3333-3333-333333333333', '11111111-1111-1111-1111-111111111111', 'user@testcompany.com', 'User One', 'user', 'U1', 'online', '$2b$10$dummy_hash_user123'),
('44444444-4444-4444-4444-444444444444', '11111111-1111-1111-1111-111111111111', 'alice@testcompany.com', 'Alice Johnson', 'user', 'AJ', 'online', '$2b$10$dummy_hash_user123'),
('55555555-5555-5555-5555-555555555555', '11111111-1111-1111-1111-111111111111', 'bob@testcompany.com', 'Bob Smith', 'user', 'BS', 'away', '$2b$10$dummy_hash_user123'),
('66666666-6666-6666-6666-666666666666', '11111111-1111-1111-1111-111111111111', 'charlie@testcompany.com', 'Charlie Brown', 'user', 'CB', 'offline', '$2b$10$dummy_hash_user123')
ON CONFLICT (id) DO UPDATE SET 
  name = EXCLUDED.name,
...
-- ============================================
-- 8. CREATE GUESTS TABLE (MISSING FROM ORIGINAL)
-- ============================================
...
-- ============================================
-- 9. ENABLE ROW LEVEL SECURITY WITH SIMPLE POLICIES
-- ============================================
...
-- ============================================
-- 11. VERIFICATION - Check everything is set up
-- ============================================
...
-- Email: alice@testcompany.com, Password: admin123
-- Email: bob@testcompany.com, Password: admin123
-- Email: charlie@testcompany.com, Password: admin123
-- ============================================ 