...
export default function LoginScreen({ onLogin }: LoginScreenProps) {
  ...
  const fillTestCredentials = (type: 'admin' | 'guest') => {
    if (type === 'admin') {
      ...
      // You can add test guest credentials here when available
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        {activeTab === 'admin' && (
          <View style={styles.formContainer}>
            ...
            >
              <Text style={styles.testButtonText}>Use Test Admin (Charles Morgan)</Text>
            </TouchableOpacity>
          </View>
        )}
        ...
        {activeTab === 'guest' && (
          <View style={styles.formContainer}>
            <View style={styles.formHeader}>
              <Text style={styles.formTitle}>Event Guest</Text>
              <Text style={styles.formSubtitle}>
                Login with credentials provided by your event organizer
              </Text>
            </View>
            ...
            <View style={styles.guestInfo}>
              <Text style={styles.guestInfoText}>
                💡 Don't have login credentials? Contact your event organizer.
              </Text>
            </View>
          </View>
        )}
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>
            Timely Mobile • Secure Event Management
          </Text>
        </View>
      </ScrollView>
    </KeyboardAvoidingView>
