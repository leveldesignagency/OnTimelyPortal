-- Add reply_to_message_id column to guests_chat_messages table
-- This column is needed for the reply functionality to work

ALTER TABLE guests_chat_messages 
ADD COLUMN IF NOT EXISTS reply_to_message_id UUID REFERENCES guests_chat_messages(message_id) ON DELETE SET NULL;

-- Add index for performance
CREATE INDEX IF NOT EXISTS idx_guests_chat_messages_reply_to ON guests_chat_messages(reply_to_message_id) WHERE reply_to_message_id IS NOT NULL;
